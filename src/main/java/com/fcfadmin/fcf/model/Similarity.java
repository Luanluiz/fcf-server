...
import com.fcfadmin.fcf.model.enuns.SmokingStatus;
import com.fcfadmin.fcf.model.interfaces.IAverageValues;

public class Similarity {

    private final RecordWeight weight;
    private final IAverageValues averageValues;

    public Similarity(RecordWeight weight, IAverageValues averageValues) {
        this.weight = weight;
